...
ll countConstruct(string target, vs &wordBank) {
...
int main() {
	...
	cout<<countConstruct("purple", numbers0)<<endl;
	cout<<countConstruct("abcdef", numbers1)<<endl;
	cout<<countConstruct("skateboard", numbers2)<<endl;
	cout<<countConstruct("enterapotentpot", numbers3)<<endl;
	cout<<countConstruct("eeeeeeeeeeeeeeeeeeeef", numbers4)<<endl;
}
